export default function LandingPage() {
    return (
        <div className="w-full h-full relative">
          <video className="w-full h-full object-cover" src="/720p.mp4" autoPlay loop muted></video> 
          <div className="absolute top-0 left-0 w-full h-full bg-black/50 flex justify-center items-center">
            <div className="text-center text-white">
              ...
              <a href="/products" className="bg-accent text-white px-6 py-3 rounded-lg hover:bg-accent-dark transition">Shop Now</a>
            </div>
          </div>
        </div>
      );
